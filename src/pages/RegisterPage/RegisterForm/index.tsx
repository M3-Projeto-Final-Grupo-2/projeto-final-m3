...
const formSchema = yup.object().shape({
    ...
    passConfirm: yup.string().oneOf([yup.ref('password')],
...
const RegisterForm = () => {
    ...
    return (
        <StyledRegisterForm onSubmit={handleSubmit(registerUser)} >
            <Input label='Usuário' placeholder='Digite seu nome...'
                id='name' register={register('name')} type='text' error={errors.name?.message} />
            <Input label='Email' placeholder='Digite seu e-mail...'
                id='email' register={register('email')} type='text' error={errors.email?.message} />
            <Input label='Senha' placeholder='Digite sua senha...'
                id='password' register={register('password')} type='password' error={errors.password?.message} />
